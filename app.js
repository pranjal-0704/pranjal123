...
console.log("Vcap "+process.env.VCAP_SERVICES);
console.log("Vcap "+constant["Mongo-Service"]);
var express = require('express'),
  routes = require('./routes'),
  http = require('http'),
  path = require('path'),
  mongoskin = require('mongoskin'),
  //dbUrl = process.env.MONGOHQ_URL || 'mongodb://myTesterpow:xyz123@localhost:27017/blog',
  dbUrl = 'mongodb://' + constant["Mongo-Service"][0].credentials.username+ ':' + constant["Mongo-Service"][0].credentials.password + '@' + constant["Mongo-Service"][0].credentials.IP + ':' + constant["Mongo-Service"][0].credentials.port + '/' + constant["Mongo-Service"][0].credentials.DBName ,
...
var app = express();
app.locals.appTitle = "Cognizant-Blog";
